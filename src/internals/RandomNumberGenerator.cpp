...
float dotProduct(GradientVector *vec1, GradientVector *vec2) { return vec1->x * vec2->x + vec1->y * vec2->y; }
...
int RandomNumberGenerator::randint(int small, int large) { return (rand() % (large - small)) + small; }